      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-100">
          ...
          >
            ...
            <md-snackbar
              :md-active.sync="pollSaved"
              :md-duration="10000"
              class="success-poll"
            >Polli u krijua me sukses!</md-snackbar>
          </form>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    removeItem(pos) {
      this.rowCounter--;
      this.pollOptions.rowData.pop(); // this pops last item, not current selection
    },
    ...
    handlePollUpload(fieldName, fileList) {
      // handle file changes
